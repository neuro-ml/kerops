...
@settings_wrapper
def AvgPoolCeilStats(x, _l1_cache_bytes, _num_warps):
...
@settings_wrapper
def AvgPoolCeilStatsBackward(inpgrad, meangrad, sqmeangrad, output, outgrad_shape, _l1_cache_bytes, _num_warps):
